...
def post():
    ...
    try:
        ...
        if len(user)==1:
            if course_id !=None and course_id !="" and task_type != None and task_type !="" and due_date!=None and due_date !="" and description != None and description != "": 
                cursor.execute("INSERT INTO tasks (course_id,task_type,due_date,description) VALUES (?,?,?,?) ",[course_id,task_type,due_date,description])
                conn.commit()
